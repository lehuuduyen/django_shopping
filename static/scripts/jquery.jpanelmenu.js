    ...
    $.jPanelMenu = function (options) {
        ...
        ;var jP = {
            options: $.extend({
                ...
                keyboardShortcuts: [{code: 27, open: false, close: true}, {
                    code: 37,
                    open: false,
                    close: true
                }, {code: 39, open: true, close: true}, {code: 77, open: true, close: true}],
                duration: 150,
            ...
            setPositionUnits: function () {
                var foundUnit = false, allowedUnits = ['%', 'px', 'em'];
            ...
            setjPanelMenuStyles: function () {
                ...
                if ($('#jPanelMenu-style-master').length == 0) {
                    $('body').append('<style id="jPanelMenu-style-master">@media only screen and (max-width: 767px) { body{width:100%}.jPanelMenu,body{overflow-x:hidden}#jPanelMenu-menu{display:block!important;position:fixed;top:0;' + jP.options.direction + ':0;height:100%;z-index:-1;overflow-x:hidden;overflow-y:scroll;-webkit-overflow-scrolling:touch;transition: 1s;}.jPanelMenu-panel{position:static;' + jP.options.direction + ':0;top:0;z-index:2;width:100%;min-height:100%;transition:1s;background:' + bgColor + '}}</style>');
                }
            },
                    ...
                    if (jP.settings.shiftFixedChildren) {
                        $(jP.fixedChildren).each(function () {
                            var id = $(this).prop("tagName").toLowerCase() + ' ' + $(this).attr('class'),
                                selector = id.replace(' ', '.'), id = id.replace(' ', '-');
            ...
            initiateKeyboardListeners: function () {
                ...
                $(document).on('keydown', function (e) {
                    var target = $(e.target), prevent = false;
