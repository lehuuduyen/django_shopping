...
(function (e, t) {
    ...
    function r(n) {
        n.find(".show_on_hover, .hovercover").each(function () {
            ...
            TweenLite.to(e(this), 0, {opacity: 0, overwrite: "all", ease: Power3.easeInOut});
            n.hover(function () {
                e(this).find(".show_on_hover, .hovercover").each(function () {
                    var n = 1;
                    if (e(this).data("maxopacity") != t) n = e(this).data("maxopacity");
                    TweenLite.to(e(this), 0, {opacity: n, overwrite: "all", ease: Power3.easeInOut})
                })
            }, function () {
                e(this).find(".show_on_hover, .hovercover").each(function () {
                    TweenLite.to(e(this), 0, {opacity: 0, ease: Power3.easeInOut})
                })
            })
        })
    }
        ...
        t.find(".closeme.inside").click(function () {
            ...
            if (e.hasClass("revactive")) {
                ...
                TweenLite.fromTo(e.find(".reveal_wrapper"), .3, {
                    ...
                    height: "100%",
                    opacity: 1
                }, {opacity: 0, top: "0%", height: "0%", ease: Power3.easeInOut});
                ...
                if (i.hasClass("revactive")) {
                    ...
                    setTimeout(function () {
                        ...
                        TweenLite.fromTo(i.find(".reveal_wrapper"), .3, {
                            ...
                            top: "0%",
                            opacity: 0
                        }, {visibility: "visible", top: "0%", height: "100%", opacity: 1, ease: Power3.easeInOut});
                        i.find(".sb-vimeo-markup, .sb-yt-markup").each(function (n) {
                            var r = e(this);
                            if (r.hasClass("sb-vimeo-markup")) var i = t.data("vimeomarkup"); else var i = t.data("ytmarkup");
    ...
    function o(e, n) {
        ...
        TweenLite.to(i, .3, {height: u + "px", ease: Power3.easeInOut});
        TweenLite.to(i.parent(), .3, {height: u + "px", ease: Power3.easeInOut});
        var a = e.find(".showbiz-navigation").outerHeight(true);
        TweenLite.to(e.closest(".forcefullwidth_wrapper_tp_banner"), .3, {height: u + a + "px", ease: Power3.easeInOut})
    }
    ...
    function f(n) {
        ...
        n.find("img").each(function () {
            ...
            if (i != t && i.length > 3 && !n.hasClass("waitingforload") && r < 4) {
                ...
                o.onload = function () {
                    n.attr("src", i);
                    TweenLite.set(n, {height: "auto", overwrite: "auto"});
                    TweenLite.fromTo(n, .2, {autoAlpha: 0}, {autoAlpha: 1, overwrite: "auto"});
                ...
                if (i != t && i.length > 3) {
                    if (n.data("lazyloadheight") != t) n.css({height: parseInt(n.data("lazyloadheight"), 0)})
                }
            }
        });
        if (r != 0) setTimeout(function () {
            f(n)
        }, 50); else e("body").trigger("resize")
    }
        ...
        e(window).resize(function () {
            ...
            p = setTimeout(function () {
                if (n.data("forceFullWidth") == true) {
                    ...
                    n.css({left: 0 - t + "px", width: e(window).width()})
                }
                h(300, n, r);
                if (n.data("das") == "on") {
                    setTimeout(function () {
        ...
        setTimeout(function () {
            ...
            if (s != 1) {
                ...
                if (p(8)) TweenLite.to(u, n / 1e3, {
                    ...
                    ease: S
                }); else TweenLite.to(u, n / 1e3, {x: 0 - e + "px", transformPerspective: 300, ease: S})
            } else {
                if (i <= o) {
                    a = a - 2;
                    ...
                    if (p(8)) TweenLite.set(u, {
                        ...
                        transformPerspective: 300,
                        ease: S
                    }); else TweenLite.set(u, {x: 0 - e + "px", transformPerspective: 300, ease: S});
                    a = a + 1;
                    e = step * a
                }
                if (a < 0) {
        ...
        setTimeout(function () {
            ...
            if (r.find(".tofullwidth.revactive .heightadjuster").length > 0) {
                ...
                if (u.parents(":hidden").length == 0) {
                    TweenLite.to(u, .3, {height: t + x + "px", ease: Power3.easeInOut});
                    TweenLite.to(u.parent(), .3, {height: t + x + "px", ease: Power3.easeInOut});
        ...
        showbizpro: function (n) {
            ...
            return this.each(function () {
                ...
                if (n.forceFullWidth == true) {
                    ...
                    i.css({maxWidth: "none", left: 0 - o + "px", position: "absolute", width: e(window).width()})
                }
                ...
                if (n.carousel == "on") i.data("carousel", 1); else i.data("carousel", 0);
                ...
                var p = e.fn.jquery.split("."), d = parseFloat(p[0]), v = parseFloat(p[1]), m = parseFloat(p[2] || "0");
                ...
                if (n.dragAndScroll == "on") {
                    ...
                    function w(e) {
                        ...
                        switch (e.type) {
                            ...
                            case"dragleft":
                                if (r > 0) r = 0;
                                TweenLite.to(b, .1, {left: r + e.gesture.deltaX, ease: Power3.easeOut});
                                break;
                            case"release":
